...
public class GameTimerService {
    ...
    public void cancelTask(String timerId, String reason) {
        ...
        if (timer != null) {
            boolean wasCancelled = timer.cancel(false); // false: don't interrupt if already running
            log.info("Attempted to cancel timer for ID: '{}'. Success: {}. Reason: {}", timerId, wasCancelled, reason);
        } else {
